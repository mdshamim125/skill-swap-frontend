...
//   const debouncedSearch = useDebounce(search, 400); // Debounce search input
...
//   // Fetch users whenever page, debouncedSearch, or role changes
//   useEffect(() => {
//     const fetchData = async () => {
//       const result = await getAllUsers(page, debouncedSearch, role);
//       setUsers(result?.data || []);
//       const total = result?.meta?.total || 0;
//       const limit = result?.meta?.limit || 10;
//       setTotalPages(Math.ceil(total / limit));
...
//       {/* Table */}
//       <UserManagementTable users={users} onActionComplete={refreshCurrentPage} />
